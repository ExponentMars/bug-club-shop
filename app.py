...
products = [
    {
        ...
        "price": 10.00,
        "desc": "The ideal setup for young ant colonies, this test tube portal allows for easy observation and care. Use it to move ants to new test tubes or as a foraging area. The test tube ports are designed for 16mm OD test tubes.",
    ...
    {
        "id": 4,
        "name": "Test Tube Portal -- 18mm OD Test Tubes",
        "price": 10.00,
        "desc": "The ideal setup for young ant colonies, this test tube portal allows for easy observation and care. Use it to move ants to new test tubes or as a foraging area. The test tube ports are designed for 18mm OD test tubes.",
        "images": ["18mm ttportal pic1.JPG", "18mm ttportal pic2.JPG"],
        "category": "Formicariums",
        "shopify_buy_button":"""<div id='product-component-1753562466454'></div><script type="text/javascript">/*<![CDATA[*/(function () { var scriptURL = 'https://sdks.shopifycdn.com/buy-button/latest/buy-button-storefront.min.js'; if (window.ShopifyBuy) { if (window.ShopifyBuy.UI) { ShopifyBuyInit(); } else { loadScript(); } } else { loadScript(); } function loadScript() { var script = document.createElement('script'); script.async = true; script.src = scriptURL; (document.getElementsByTagName('head')[0] || document.getElementsByTagName('body')[0]).appendChild(script); script.onload = ShopifyBuyInit; } function ShopifyBuyInit() { var client = ShopifyBuy.buildClient({ domain: 'dpd4di-jb.myshopify.com', storefrontAccessToken: 'c13ce63af0fa528eefd684a1445824d9', }); ShopifyBuy.UI.onReady(client).then(function (ui) { ui.createComponent('product', { id: '9876510933294', node: document.getElementById('product-component-1753562466454'), moneyFormat: '%24%7B%7Bamount%7D%7D', options: { "product": { "styles": { "product": { "@media (min-width: 601px)": { "max-width": "calc(25% - 20px)", "margin-left": "20px", "margin-bottom": "50px" } }, "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px", "padding-left": "69px", "padding-right": "69px" } }, "contents": { "img": false, "title": false, "price": false }, "text": { "button": "Add to cart" } }, "productSet": { "styles": { "products": { "@media (min-width: 601px)": { "margin-left": "-20px" } } } }, "modalProduct": { "contents": { "img": false, "imgWithCarousel": true, "button": false, "buttonWithQuantity": true }, "styles": { "product": { "@media (min-width: 601px)": { "max-width": "100%", "margin-left": "0px", "margin-bottom": "0px" } }, "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px", "padding-left": "69px", "padding-right": "69px" } }, "text": { "button": "Add to cart" } }, "option": {}, "cart": { "styles": { "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px" } }, "text": { "total": "Subtotal", "button": "Checkout" }, "contents": { "note": true } }, "toggle": { "styles": { "toggle": { "background-color": "#ffd700", ":hover": { "background-color": "#e6c200" }, ":focus": { "background-color": "#e6c200" } }, "count": { "color": "#000000", ":hover": { "color": "#000000" } }, "iconPath": { "fill": "#000000" } } }}, }); }); }})();/*]]>*/</script>"""
    },
    {
        "id": 5,
        ...
        "category": "Formicariums",
        "shopify_buy_button":"""<div id='product-component-1753562560703'></div><script type="text/javascript">/*<![CDATA[*/(function () { var scriptURL = 'https://sdks.shopifycdn.com/buy-button/latest/buy-button-storefront.min.js'; if (window.ShopifyBuy) { if (window.ShopifyBuy.UI) { ShopifyBuyInit(); } else { loadScript(); } } else { loadScript(); } function loadScript() { var script = document.createElement('script'); script.async = true; script.src = scriptURL; (document.getElementsByTagName('head')[0] || document.getElementsByTagName('body')[0]).appendChild(script); script.onload = ShopifyBuyInit; } function ShopifyBuyInit() { var client = ShopifyBuy.buildClient({ domain: 'dpd4di-jb.myshopify.com', storefrontAccessToken: 'c13ce63af0fa528eefd684a1445824d9', }); ShopifyBuy.UI.onReady(client).then(function (ui) { ui.createComponent('product', { id: '9876511392046', node: document.getElementById('product-component-1753562560703'), moneyFormat: '%24%7B%7Bamount%7D%7D', options: { "product": { "styles": { "product": { "@media (min-width: 601px)": { "max-width": "calc(25% - 20px)", "margin-left": "20px", "margin-bottom": "50px" } }, "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px", "padding-left": "69px", "padding-right": "69px" } }, "contents": { "img": false, "title": false, "price": false }, "text": { "button": "Add to cart" } }, "productSet": { "styles": { "products": { "@media (min-width: 601px)": { "margin-left": "-20px" } } } }, "modalProduct": { "contents": { "img": false, "imgWithCarousel": true, "button": false, "buttonWithQuantity": true }, "styles": { "product": { "@media (min-width: 601px)": { "max-width": "100%", "margin-left": "0px", "margin-bottom": "0px" } }, "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px", "padding-left": "69px", "padding-right": "69px" } }, "text": { "button": "Add to cart" } }, "option": {}, "cart": { "styles": { "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px" } }, "text": { "total": "Subtotal", "button": "Checkout" }, "contents": { "note": true } }, "toggle": { "styles": { "toggle": { "background-color": "#ffd700", ":hover": { "background-color": "#e6c200" }, ":focus": { "background-color": "#e6c200" } }, "count": { "color": "#000000", ":hover": { "color": "#000000" } }, "iconPath": { "fill": "#000000" } } }}, }); }); }})();/*]]>*/</script>"""
    },
    {
        "id": 6,
        ...
        "category": "Formicariums",
        "shopify_buy_button":"""<div id='product-component-1753562507115'></div><script type="text/javascript">/*<![CDATA[*/(function () { var scriptURL = 'https://sdks.shopifycdn.com/buy-button/latest/buy-button-storefront.min.js'; if (window.ShopifyBuy) { if (window.ShopifyBuy.UI) { ShopifyBuyInit(); } else { loadScript(); } } else { loadScript(); } function loadScript() { var script = document.createElement('script'); script.async = true; script.src = scriptURL; (document.getElementsByTagName('head')[0] || document.getElementsByTagName('body')[0]).appendChild(script); script.onload = ShopifyBuyInit; } function ShopifyBuyInit() { var client = ShopifyBuy.buildClient({ domain: 'dpd4di-jb.myshopify.com', storefrontAccessToken: 'c13ce63af0fa528eefd684a1445824d9', }); ShopifyBuy.UI.onReady(client).then(function (ui) { ui.createComponent('product', { id: '9876511883566', node: document.getElementById('product-component-1753562507115'), moneyFormat: '%24%7B%7Bamount%7D%7D', options: { "product": { "styles": { "product": { "@media (min-width: 601px)": { "max-width": "calc(25% - 20px)", "margin-left": "20px", "margin-bottom": "50px" } }, "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px", "padding-left": "69px", "padding-right": "69px" } }, "contents": { "img": false, "title": false, "price": false }, "text": { "button": "Add to cart" } }, "productSet": { "styles": { "products": { "@media (min-width: 601px)": { "margin-left": "-20px" } } } }, "modalProduct": { "contents": { "img": false, "imgWithCarousel": true, "button": false, "buttonWithQuantity": true }, "styles": { "product": { "@media (min-width: 601px)": { "max-width": "100%", "margin-left": "0px", "margin-bottom": "0px" } }, "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px", "padding-left": "69px", "padding-right": "69px" } }, "text": { "button": "Add to cart" } }, "option": {}, "cart": { "styles": { "button": { "color": "#000000", ":hover": { "color": "#000000", "background-color": "#e6c200" }, "background-color": "#ffd700", ":focus": { "background-color": "#e6c200" }, "border-radius": "0px" } }, "text": { "total": "Subtotal", "button": "Checkout" }, "contents": { "note": true } }, "toggle": { "styles": { "toggle": { "background-color": "#ffd700", ":hover": { "background-color": "#e6c200" }, ":focus": { "background-color": "#e6c200" } }, "count": { "color": "#000000", ":hover": { "color": "#000000" } }, "iconPath": { "fill": "#000000" } } }}, }); }); }})();/*]]>*/</script>"""
    }
